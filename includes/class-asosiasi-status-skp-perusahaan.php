<?php
/**
 * Class untuk menangani operasi Status SKP Perusahaan
 *
 * @package Asosiasi
 * @version 1.0.0
 * Path: includes/class-asosiasi-status-skp-perusahaan.php
 * 
 * Changelog:
 * 1.0.0 - 2024-11-17
 * - Initial release
 * - Added status update with history
 * - Added status history retrieval
 */

class Asosiasi_Status_Skp_Perusahaan {
    /**
     * Nama tabel database
     */
    private $table_skp;
    ...
    public function __construct() {
        global $wpdb;
        $this->table_skp = $wpdb->prefix . 'asosiasi_skp_perusahaan';
