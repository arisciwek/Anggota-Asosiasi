 ...
 * @author      arisciwek
 * 
 * Path: admin/views/dip-template-settings.php
 * 
 ...
 * 
 * Usage:
 * Dipanggil dari DocGen_WPClass_Settings_Page::render_dip_template_settings()
 * 
...
<div class="template-upload-tab">
    <div class="card">
        ...
        <?php $this->render_dip_template_list($settings['template_dir']); ?>
