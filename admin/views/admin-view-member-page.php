...
if ($member) {
    ...
    <div class="wrap">
        ...
        <!-- Tambahkan container flex -->
        <div style="display: flex; gap: 20px;">
            <!-- Kolom Kiri - Semua card yang sudah ada -->
            <div style="flex: 0 0 45%;">
                <!-- Company Information Card, Services Card, dan Actions Card tetap sama -->
            ...
            <!-- Kolom Kanan - Template SKP -->
            <div style="flex: 0 0 55%;">
                <?php 
                $skp_template = dirname(__FILE__) . '/admin-view-member-skp-template.php';
    ...
    <?php
    // Modal template
    $modal_template = dirname(__FILE__) . '/admin-view-member-modal-template.php';
    if (file_exists($modal_template)) {
        include $modal_template;
    } else {
        echo "Template modal tidak ditemukan di: " . $modal_template;
    }
